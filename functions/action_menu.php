        ...
        if ($cate_child) {
            ...
            if ($level == 0) {
                if (isset($_SESSION['user_gbvn_id'])) {
                    ...
                    echo '<a href="#" class="link_main_menu_1">Tài khoản</a>';
                    echo '<ul class="list_main_menu_2">
                    <li class="item_main_menu_2"><a href="/thong-bao" class="link_main_menu_2"><i class="fa fa-globe"></i> Thông báo</a></li>
                    <li class="item_main_menu_2"><a href="/tu-sach-cua-toi" class="link_main_menu_2"><i class="fa fa-heart"></i> Tủ sách của tôi</a></li>
                    <li class="item_main_menu_2"><a href="/sach-dang-nghe-do" class="link_main_menu_2"><i class="fa fa-headphones"></i> Sách đang nghe</a></li>
                    <li class="item_main_menu_2"><a href="/tai-tai-lieu" class="link_main_menu_2"><i class="fa fa-download"></i> Tải tài liệu</a></li>
                    <li class="item_main_menu_2"><a href="/thong-tin-ca-nhan" class="link_main_menu_2"><i class="fa fa-user"></i> Thông tin cá nhân</a></li>
                    <li class="item_main_menu_2"><a href="/kich-hoat-ma-code" class="link_main_menu_2"><i class="fa fa-unlock-alt"></i> Kích hoạt bằng mã code</a></li>
                    <li class="item_main_menu_2"><a href="/dang-xuat" class="link_main_menu_2"><i class="fa fa-sign-out"></i> Đăng xuất</a></li>
                    </ul>';
                    echo '</li>';
                    echo '<li class="item_main_menu_1"><a href="#" class="link_main_menu_1" data-toggle="modal" data-target="#kich-hoat">Đăng Ký Thẻ Kích Hoạt</a></li>';
                } else {
                    echo '<li class="item_main_menu_1"><a href="#" class="link_main_menu_1" data-toggle="modal" data-target="#dang-ky">Đăng ký</a></li>';
                    echo '<li class="item_main_menu_1"><a href="#" class="link_main_menu_1" data-toggle="modal" data-target="#dang-nhap">Đăng nhập</a></li>';
                }
