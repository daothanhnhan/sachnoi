...
class action_page extends library{
   ...
   //          }
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddsssisiiissssssssssssssssisssssii');
		...
		public function updateProduct(){
			...
			$product_review = isset($_POST['product_review']) ? $_POST['product_review'] : '0';

			$dang_nghe = isset($_POST['dang_nghe']) ? $_POST['dang_nghe'] : '0';
   ...
   //          }
	    	...
	    	if (isset($_FILES['fileUpload3']) && $_FILES['fileUpload3']['name'] != "") {
		    	...
		    	$this->uploadPicture($src1, $img['name'], $img['tmp_name']);	
			...
			if (!$this->Update_1('product',
								  ...
								  'sssssssdddsssisiiisssssssssssssssssiiissssii')) {
