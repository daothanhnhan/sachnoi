...
<form action="" method="post" enctype="multipart/form-data" id="updateProduct">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <a href="index.php?page=audio-phu&product_id=<?= $row['product_id'] ?>" title="">Audio phụ</a>
        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <p class="titleRightNCP">Lượt nghe</p>

                    <input type="number" class="txtNCP1" value="<?php echo $row['product_review'];?>" name="product_review"/>

                </div>  

                <div class="subColContent" >

                    <p class="titleRightNCP">Đang nghe</p>

                    <input type="number" class="txtNCP1" value="<?php echo $row['dang_nghe'];?>" name="dang_nghe"/>
    ...
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            <span class="titLeftNCP">MP3</span>
            <p class="subLeftNCP">Thay mp3 cho website<br /><br /></p>                         
        </div>
        <div class="boxNodeContentPage">
            <div id="wrapper">
                ...
                <?php 
                    if ($row['mp3'] != '' || true) {
                    ?>
                        <!-- <img src="../images/<?= $row['mp3']?>" class="img-responsive" alt="Image"> -->
                        <input type="text" name="mp3" value="<?= $row['mp3']?>" style="width: 100%;">
                    <?php
                    }
                ?>                
                </div>
    ...
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            <span class="titLeftNCP">MP3 nghe thử</span>
            <p class="subLeftNCP">Thay mp3 cho website<br /><br /></p>                         
        </div>
        <div class="boxNodeContentPage">
            <div id="wrapper">
                <div id="image-holder">
                    ...
                    <input type="text" name="product_sub_info1" value="<?= $row['product_sub_info1']?>" style="width: 100%;">
