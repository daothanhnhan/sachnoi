<?php 
	...
	function thuong_hieu () {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO khoa_hoc (name, note, image, popup) VALUES ('$name', '$note', '$image', '$popup')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một khoá học.\');window.location.href="index.php?page=khoa-hoc"</script>';
			} else {
