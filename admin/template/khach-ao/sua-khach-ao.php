<?php 
	...
	function khach_ao ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE khach_ao SET name = '$name', phone = '$phone' $add WHERE id = $id";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã sửa được một khách ảo.\')</script>';
			} else {
	...
	$info = $action->getDetail('khach_ao', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP">Nhập thông tin khách ảo<br /><br /></p>     
            <p class="subLeftNCP"><a href="index.php?page=khach-ao">Quay lại</a><br /><br /></p>     
