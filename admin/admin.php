        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    ///////////// audio phu ///////////////
                    case "audio-phu":
                        include_once("template/audio-phu/audio-phu.php");
                        break;
                    case "them-audio-phu":
                        include_once("template/audio-phu/them-audio-phu.php");
                        break;
                    case "sua-audio-phu":
                        include_once("template/audio-phu/sua-audio-phu.php");
                        break;
                    case "xoa-audio-phu":
                        include_once("template/audio-phu/xoa-audio-phu.php");
                        break;
                    ///////////// khoa hoc ////////////////
                    case "khoa-hoc":
                        include_once("template/khoa-hoc/khoa-hoc.php");
                        break;
                    case "them-khoa-hoc":
                        include_once("template/khoa-hoc/them-khoa-hoc.php");
                        break;
                    case "sua-khoa-hoc":
                        include_once("template/khoa-hoc/sua-khoa-hoc.php");
                        break;
                    case "xoa-khoa-hoc":
                        include_once("template/khoa-hoc/xoa-khoa-hoc.php");
                        break;
                    //////////// khach ao /////////////////
                    case "khach-ao":
                        include_once("template/khach-ao/khach-ao.php");
                        break;
                    case "them-khach-ao":
                        include_once("template/khach-ao/them-khach-ao.php");
                        break;
                    case "sua-khach-ao":
                        include_once("template/khach-ao/sua-khach-ao.php");
                        break;
                    case "xoa-khach-ao":
                        include_once("template/khach-ao/xoa-khach-ao.php");
                        break;
                    ///////////// gia goi /////////////////
                    case "gia-goi":
                        include_once("template/gia-goi/gia-goi.php");
                        break;
                    ///////////// so huu //////////////////
                    case "so-huu":
                        include_once("template/so-huu/so-huu.php");
                        break;
                    case "them-so-huu":
                        include_once("template/so-huu/them-so-huu.php");
                        break;
                    case "sua-so-huu":
                        include_once("template/so-huu/sua-so-huu.php");
                        break;
                    case "xoa-so-huu":
                        include_once("template/so-huu/xoa-so-huu.php");
                        break;
                    ///////////// nghe thu ////////////////
                    case "nghe-thu":
                        include_once("template/nghe-thu/nghe-thu.php");
                        break;
                    case "them-nghe-thu":
                        include_once("template/nghe-thu/them-nghe-thu.php");
                        break;
                    case "sua-nghe-thu":
                        include_once("template/nghe-thu/sua-nghe-thu.php");
                        break;
                    case "xoa-nghe-thu":
                        include_once("template/nghe-thu/xoa-nghe-thu.php");
                        break;
                    ///////////// dang ky /////////////////
                    case "dang-ky-goi":
                        include_once("template/dang-ky/dang-ky-goi.php");
                        break;
                    ///////////// Default /////////////////
                    default:
