...
<head>
    ...
    <!-- <meta name="viewport" content="width=420, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0"> -->
...
<a href="tel:<?= $rowConfig['content_home3'] ?>" class="suntory-alo-phone suntory-alo-green" id="suntory-alo-phoneIcon" style="right: 0px; bottom: 0px;">
...
<div class="gb-content">
    ...
    if (isset($_GET['page'])){
        ...
        switch ($urlAnalytic) {
            ...
            case 'tu-sach-cua-toi':
                include_once dirname(__FILE__) . DIR_THEMES . "tu-sach-cua-toi.php";break;

            case 'tu-sach':
                include_once dirname(__FILE__) . DIR_THEMES . "tu-sach.php";break;

            case 'thong-tin-ca-nhan':
                include_once dirname(__FILE__) . DIR_THEMES . "thong-tin-ca-nhan.php";break;

            case 'thong-bao':
                include_once dirname(__FILE__) . DIR_THEMES . "thong-bao.php";break;

            case 'sach-dang-nghe-do':
                include_once dirname(__FILE__) . DIR_THEMES . "sach-dang-nghe-do.php";break;

            case 'sach-nghe-nhieu':
                $title = "Sách được nghe nhiều";
                include_once dirname(__FILE__) . DIR_THEMES . "sach-nghe-nhieu.php";break;

            case 'kich-hoat-ma-code':
                include_once dirname(__FILE__) . DIR_THEMES . "kich-hoat-ma-code.php";break;

            case 'thank-you':
                include_once dirname(__FILE__) . DIR_THEMES . "thank-you.php";break;
        }
    }
