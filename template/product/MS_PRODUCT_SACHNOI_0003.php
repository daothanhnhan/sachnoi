<?php 
    $them_vao_tu_sach = $action->getList('them_vao_tu_sach', 'user_id', $_SESSION['user_gbvn_id'], 'id', 'desc', $trang, '12', $_GET['page'], $_GET['page']);
    // $yeu_thich = json_decode($user['product_id']);
...
<div class="gb-page-sanpham_cuanhom home-procat tu-sach-yeu-thich">
    ...
    <div class="container padding-mobile-procat">
        ...
        <h1 class="title">Tủ Sách Yêu Thích</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="row" style="display: flex;flex-wrap: wrap;">
                ...
                foreach ($them_vao_tu_sach['data'] as $id) { 
            ...
            <div><?= $them_vao_tu_sach['paging'] ?></div>
