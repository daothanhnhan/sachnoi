<?php 
    ...
    if (isset($_GET['slug']) && $_GET['slug'] != '') {
        ...
        $rows = $action_product->getProductList_byMultiLevel_orderProductId_nghe_nhieu($rowCat['productcat_id'],'desc',$trang,12,$slug);//var_dump($rows);
